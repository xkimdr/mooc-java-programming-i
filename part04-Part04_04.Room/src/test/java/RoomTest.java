...
public class RoomTest {
    ...
    public void hasTwoObjectVariables() {
        ...
        Assert.assertTrue("Have you made two object variables in class Room? Number of object variables found: "
                + numberOfObjectVariables, numberOfObjectVariables == 2);
    }
    ...
    public void hasAConstructor() {
        ...
        try {
            ...
            Assert.fail(
                    "Have you made a constructor public Room(String code, int seats)? Make sure the name has been spelled exactly right.");
        }
    }
    ...
    public void constructorSetsAValueToTheCode() {
        ...
        try {
            classInstance = Reflex.reflect("Room").constructor().taking(String.class, int.class).invoke("b111", 25);
        } catch (Throwable t) {
            Assert.fail("Constructor call new Room(\"b111\", 25); failed. Check the constructor method.");
        }

        Assert.assertEquals(
                "Constructor must set the value of a parameter to the value of an object variable. The object variable  \"code\" was not set.",
                "b111", valueOfObjectVariable(classInstance, "code"));
    }
    ...
    public void constructorSetsAValueToTheCode2() {
        ...
        Assert.assertEquals(
                "Constructor must set the value of a parameter to the value of an object variable. The object variable  \"code\" was not set.",
                "b215", valueOfObjectVariable(classInstance, "code"));
    }
    ...
    public void constructorSetsTheValueOfSeats() {
        ...
        Assert.assertEquals(
                "Constructor must set the value of a parameter to the value of an object variable. The object variable  \"seats\" was not set.",
                25, valueOfObjectVariableInt(classInstance, "seats"));
    }
    ...
    public void constructorSetsTheValueOfSeats2() {
        ...
        Assert.assertEquals(
                "Constructor must set the value of a parameter to the value of an object variable. The object variable  \"seats\" was not set.",
                75, valueOfObjectVariableInt(classInstance, "seats"));
    }
    ...
    private void checkObjectVariables(String variableName, Class type, String asString) {
        ...
        Assert.assertTrue("Does the class Room have the object variable \"" + asString + ";\"?",
                classInstance.getType().equals(type));
        Assert.assertFalse("Does the class Room have the object variable \"" + asString + ";\"?",
                classInstance.isAccessible());
    }
